...
while($row = mysqli_fetch_array($result))
  {
	  ...
	  $price=$row['price'];
	  $totalcons=$pres - $prev;
	  $totalcons = ($totalcons /1000 );
	  //$bill=($totalcons)/1000 * $price;
	  //$bill=($totalcons /1000) * 180;
	  $bill= $row['m_bill']; 
	  $date=$row['date'];
...
<div id="data">
<center>
<h4><center><b>JG Water Bill</b></center></h4>
<p></p>
<p><strong>Bill Invoice</strong></p>
<p>Phone: +254 722 297330</p>
...
<tr><td bordercolor="#000000">Consuption: </td><td><b><i><?php echo $totalcons;?> </td><td bordercolor="#000000">Price / unit : 180 /m3 </td>
<td><b><i><?php echo $price; ?>&nbsp;TKshs </td>
</tr>
<tr><td colspan="4"><center><h2><?php echo $mi; ?> Total Invoice:<b><i> <?php echo $bill; ?><b><i> /= Kshs</h2></center></td></tr>
<?php
$session=$_SESSION['id'];
include 'db.php';
